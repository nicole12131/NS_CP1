...
# The player can go to Dawn Winery, Starsnatch Cliff, Nameless Island, Anemo Archon Statue, Stormbearer Mountains, Springvale, Mondstadt City, Stormterror's Lair, and Starfell Lake.
...
# create a function that runs the combats
    ...
    # inside of the function create a loop that repeats the combat
        # if the player has 0 of HP they dies and they need to restart the game
        # if the abyss mage has 0 of HP the player wins, player can continue the game
        # if the dragon has 0 of HP the player wins the dragon is now on their side, the player can continue the game

# create a list that has all of the items that the player has picked up
...
#  define a function that shows the player's inventory
    ...
    # if the item is on the inventory the items is removed from the inventory
